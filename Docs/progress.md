...
### オーディオライブラリの作成
詳細は [`Docs/Audio/`](./Audio/) 以下のドキュメントを参照（作成予定）。

---

## シャドウマップ関連ドキュメント

`Docs/ShadowMap/` フォルダにまとめてある。
- [`ShadowMap/00_overview.md`](./ShadowMap/00_overview.md) ― 全体概要・Stepの一覧
- `ShadowMap/Step1.md` ? `ShadowMap/Step5.md` ― 各ステップの手順
...
2. このファイルで現在の進捗を確認する
3. GitHub Copilot に「オーディオライブラリを作りたい」と指示する
